    ...
    return {
        ...
        controller: ["$scope","$element",function ($scope, $element) {
            $scope.minimalize = function () {
                //$(".navbar-default").toggleClass("slideInLeft");
                //$(".navbar-default").toggleClass("slideOutLeft");
                //$("#page-wrapper").toggleClass("marginInLeft");
                

                //$('#page-wrapper').toggleClass("no-margin");
...
function stSummary() {
    return {
        restrict: 'E',
        require: '^stTable',
        template: '<div style="padding-top: 10px">Items: <b>{{size}}</b></div>',
        scope: {},
